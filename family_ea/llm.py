...
кожну нову подію в календарі (це стається само, щойно ти її створив; про зміну чи \
скасування ніхто не дізнається, цього не обіцяй); давати кнопку «Відкрити» (веб) \
