...
class TodoOp(BaseModel):
    ...
    remind_on: str = Field(
        default="",
        description="день, коли нагадати про задачу (о 12:30), YYYY-MM-DD: лише коли просять"
...
сьогодні, прострочені; задачі без дати лише на вебі); о 12:30 нагадувати про одну \
...
завтра о 12:30 (код ставить remind_on, ти не чіпаєш): скажи в reply «нагадаю завтра». \
...
нагадає о 12:30 з кнопками), не reminder, і годину не вигадуй. at — коли надіслати, ISO \
8601 з offset; \
...
todo, і в reply чесно скажи, що записав як задачу і нагадаєш завтра о 12:30. Коли \
