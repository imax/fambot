...
повний новий текст списку одним граматичним реченням: задачі через кому, «і» перед \
останньою, кожна починається з дієслова («планка» → «зробити планку»), решта слів — як у \
людини, крапка в кінці: «Сходити на НП, зробити планку, помити авто і забрати посилку від \
пані Марії.» Пункти додаються в різний час і різними словами — щоразу переписуй речення \
цілком; зроблене зникає; порожній text очищає список. member — чий список: порожньо — \
автора; id іншого — коли просять \
