...
поверсі»); note — що ще варто знати, щоб упізнати річ (варіант, що всередині, стан), але \
не місце і не довідка про неї: термін дії, номер, серія, ціна, умови — це нотатки (notes), \
