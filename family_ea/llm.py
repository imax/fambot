...
«Зробити до п'ятниці» і «нагадай про це в п'ятницю» — те саме, due = п'ятниця; окремого \
...
«нагадай Анні завтра про клініки», коли така задача є в контексті, — update з її id і due \
на той день, а не reminder і не нова задача; у reply скажи «поставив на четвер». «Не \
...
«Нагадай завтра про …» без години про наявну задачу — це due тієї задачі (вона буде в \
ранковому дайджесті), не reminder, і годину не вигадуй. at — коли надіслати, ISO \
8601 з offset; \
